/**
 * Cuando renderizamos el componente
 * y se muestra todo, se dispara el useLayoutEffect
 * Nos puede serviror para obetener las mediciones del tamaño de un contenedor
 */
